...
// import './ethsync_homepage.dart';
// import './ethsync_navdrawer.dart';
// import './ethsync_localizations.dart';
// // import './ethsync_navbar.dart';

// const String testDevice = 'YOUR_DEVICE_ID';
// const String testDevice = 'ANE L01';
...
class EthSync extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: EthSyncHome(title: 'EthSync homepage'),
    );
  }
}

class EthSyncHome extends StatefulWidget {
  EthSyncHome({Key? key, required this.title}) : super(key: key);
  ...
  @override
  _EthSyncPageState createState() => _EthSyncPageState();
}

class _EthSyncPageState extends State<EthSyncHome> {
...
//       'synchronisation',
//     ],
//     contentUrl: 'http://www.ethsync.app',
//     childDirected: false,
...
//   }
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      //   const Locale('de', 'DE'),
      //   const Locale('en', 'US'),
      //   const Locale('en_GB', 'GB'),
      //   const Locale('fr', 'FR'),
      //   // const Locale('de', 'DE'),
      //   // const Locale('en_GB', 'EN_GB'),
      //   // const Locale('es', 'ES'),
      //   // const Locale('fr', 'FR'),
      //   // const Locale('fr_CA', 'FR_CA'),
      //   // const Locale('en', 'en_IE'),
      //   // const Locale('it', 'IT'),
      //   // const Locale('jp', 'JP'),
      //   // const Locale('pt', 'PT'),
      //   // const Locale('pt_BR', 'PT_BR'),
      //   // const Locale('zn', 'ZN'),
      // ],
      theme: ThemeData(
          //this kills qr colour
...
// output current Locale of Localizations.localOf();
// Locale myLocale = Localizations.localeOf(context);
...
//     // by the _i33ncrementCounter method above.
//     //
